...
initial = {
    "O3": {"BNS": 892762, "NSBH": 35962, "BBH": 71276},
    "O4": {"BNS": 892762, "NSBH": 35962, "BBH": 71276},
    "O5": {"BNS": 892762, "NSBH": 35962, "BBH": 71276},
}

detection = {
    "O3": {"BNS": 460, "NSBH": 79, "BBH": 4891},
    "O4": {"BNS": 1004, "NSBH": 184, "BBH": 7070},
    "O5": {"BNS": 2003, "NSBH": 356, "BBH": 9809},
}

resampling = {
    "O3": {"BNS": 390079, "NSBH": 49177, "BBH": 560744},
    "O4": {"BNS": 587016, "NSBH": 60357, "BBH": 352627},
...
ax1.bar(
    ...
    width=largeur_barre,
    color=nsbh_color,
    edgecolor=["black" for i in NSBH_detect],
    linewidth=1,
)
ax1.bar(
    x2[i],
    ...
    width=largeur_barre,
    color=bns_color,
    edgecolor=["black" for i in BNS_detect],
    linewidth=1,
)
ax1.bar(
    x3[i],
    ...
    width=largeur_barre,
    color=bbh_color,
    edgecolor=["black" for i in BBH_detect],
    linewidth=1,
)
...
ax2.set_xticks(
    [r + largeur_barre for r in range(len(distributions))],
    ["GWTC-3", "LRR"],
    ha="center",
...
ax2.text(
    x1[0] + 0.03,
    gwtc_3_event_nsbh - 0.09,
    f"{np.round(gwtc_3_event_nsbh[0][0], 2)}%",
    ha="left",
    color="navy",
    fontsize=18,
    fontweight="bold",
...
ax2.text(
    x2[0] + 0.03,
    gwtc_3_event_bns - 0.025,
    f"{np.round(gwtc_3_event_bns[0][0], 2)}% ",
    ha="left",
    color="navy",
    fontsize=18,
    fontweight="bold",
...
ax2.text(
    x3[0] + 0.03,
    gwtc_3_event_bbh - 1.2,
    f"{np.round(gwtc_3_event_bbh[0][0], 1)}% ",
    ha="left",
    color="navy",
    fontsize=18,
    fontweight="bold",
...
ax2.text(
    x1[1] + 0.03,
    petrov_event_nsbh - 0.09,
    f"{np.round(petrov_event_nsbh[0][0], 2)}%",
    ha="left",
    color="navy",
    fontsize=18,
    fontweight="bold",
...
ax2.text(
    x2[1] + 0.03,
    petrov_event_bns - 0.025,
    f"{np.round(petrov_event_bns[0][0], 2)}% ",
    ha="left",
    color="navy",
    fontsize=18,
    fontweight="bold",
...
ax2.text(
    x3[1] + 0.03,
    petrov_event_bbh - 0.14,
    f"{np.round(petrov_event_bbh[0][0], 2)}%",
    ha="left",
    color="navy",
    fontsize=18,
    fontweight="bold",
