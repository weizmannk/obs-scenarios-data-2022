...
freq_L1, psd_L1     = np.loadtxt(f'{path}/L1_mcvt-estimate-psd_reference-1366934418-2678400.txt', unpack=True, skiprows=1)
freq_H1, psd_H1     = np.loadtxt(f'{path}/H1_mcvt-estimate-psd_reference-1366934418-2678400.txt', unpack=True, skiprows=1)
