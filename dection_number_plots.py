...
#Text
##################
ax2.text(x1[0]+0.03, gwtc_3_event_nsbh-0.04, f'{np.round(gwtc_3_event_nsbh[0][0], 2)}%',   ha = 'left', color='navy', fontsize = 18, fontweight ='bold')
...
ax2.text(x3[0]+0.03, gwtc_3_event_bbh-0.2,  f'{np.round(gwtc_3_event_bbh[0][0], 1)}% ',  ha = 'left', color='navy', fontsize = 18, fontweight ='bold')

ax2.text(x1[1]+0.03, petrov_event_nsbh-0.025, f'{np.round(petrov_event_nsbh[0][0], 2)}%',   ha = 'left', color='navy', fontsize = 18, fontweight ='bold')
ax2.text(x2[1]+0.03,  petrov_event_bns-0.015, f'{np.round(petrov_event_bns[0][0], 2)}% ',   ha = 'left', color='navy', fontsize = 18, fontweight ='bold')
ax2.text(x3[1]+0.03,  petrov_event_bbh-0.03, f'{np.round(petrov_event_bbh[0][0], 2)}%',   ha = 'left', color='navy', fontsize = 18, fontweight ='bold')
...
ax1.set_xlim([0,  x3[1]+ 0.5])

plt.subplots_adjust(hspace=0.1)
#fig.tight_layout()

plt.savefig(f'obs_events_hist_plot_simple.pdf')
plt.savefig(f'CBC_detection_number_simple.png')
plt.close()
